...
import { MsjDiferenciaN2FinalizadoComponent } from './msj-diferencia-n2-finalizado/msj-diferencia-n2-finalizado.component';
...
@Component({
  selector: 'app-diferencia-n2',
  templateUrl: './diferencia-n2.component.html',
  styleUrls: ['./diferencia-n2.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DiferenciaN2Component implements OnInit {
  ...
  getTodosEjercicicosDiferencia2() {
    ...
    let diferenciaDos = 'Diferencia 2'
  ...
  validarRespuestasA(ejercicio: Ejercicionivel2) {
    ...
    if (respuestaA == ejercicio.respuestacorrecta) {
      if (idEjercicio == 24) {
        ...
        const dialogRef = this.dialog.open(MsjDiferenciaN2FinalizadoComponent, {
          width: '450px',
          panelClass: 'msj-nivel-finalizado',
          autoFocus: false
        });
      }
    } else if (idEjercicio == 17 && respuestaA != ejercicio.respuestacorrecta) {
      ...
      this.validarRespuesta = true;
      this.respuestaCorrecta = ejercicio.respuestacorrecta; // mostrar respuesta correcta
    } else if (idEjercicio == 21 && respuestaA != ejercicio.respuestacorrecta) {
      this.solucionRespuestaA = false; // Mostrar solución
      this.solucionRespuestaB = true;
      this.solucionRespuestaD = true;
      this.solucionRespuestaC = true;
  ...
  validarRespuestasB(ejercicio: Ejercicionivel2) {
    ...
    if (respuestaB == ejercicio.respuestacorrecta) {
      ...
      this.ingresarRespuesta = true;
      this.respuestaUsuario = '';
    } else if (idEjercicio == 22 && respuestaB != ejercicio.respuestacorrecta) {
      this.solucionRespuestaB = false; // Mostrar solución
      this.solucionRespuestaA = true;
      this.solucionRespuestaD = true;
      this.solucionRespuestaC = true;
  ...
  validarRespuestaUsuario(ejercicio: Ejercicionivel2) {
    ...
    } else if (idEjercicio == 21 && this.respuestaUsuario != respuestaCorrecta) {
      this.validarRespuesta = false;
      this.respuestaCorrecta = ejercicio.respuestacorrecta; // mostrar respuesta correcta
    } else if (idEjercicio == 22 && this.respuestaUsuario != respuestaCorrecta) {
      this.validarRespuesta = false;
      this.respuestaCorrecta = ejercicio.respuestacorrecta; // mostrar respuesta correcta
    }
  }
